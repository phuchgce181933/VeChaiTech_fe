...
export default function Contact() {
    ...
    return (
        <section className="relative py-10 px-8 md:px-6 bg-gradient-to-b from-[#aff0b5] via-[#b2e0b6] to-[#17e11e]">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">

                {/* LEFT CONTENT */}
                <div className="space-y-6">
                    <h2 className="text-5xl text-emerald-800 mb-10">
                        Liên hệ & Hỗ trợ
                    </h2>
                    ...
                    <ul className="text-3xl space-y-3 text-gray-600">
                        <li>Thời gian phản hồi: trong 24h</li>
                    </ul>
          ...
          shadow-2xl border border-emerald-200 p-8 md:p-10">
